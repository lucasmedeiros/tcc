...
dados_liteme_pow_com_data_filtrados <- dados_liteme_pow_com_data %>% 
  filter(data != as.Date("2021-07-01") & data != as.Date("2021-07-04") & data != as.Date("2021-07-05") &
         data != as.Date("2021-07-17") & data != as.Date("2021-07-19") & data != as.Date("2021-07-20") &
         data != as.Date("2021-07-21") & data != as.Date("2021-07-22") & data != as.Date("2021-08-16") &
         data != as.Date("2021-08-20") & data != as.Date("2021-09-03") & data != as.Date("2021-09-16") &
         data != as.Date("2021-09-25") & data != as.Date("2021-10-02") & data != as.Date("2021-10-23") &
         data != as.Date("2021-11-27"))
